...
async function setup(){
    let venues = await sendApiRequest("https://chappen.herokuapp.com/api/venues","GET")
    createVenues(venues)
}
...
function createRemoveButton(id){
    ...
    button.onclick = async () =>{
        await sendApiRequest(`https://chappen.herokuapp.com/api/venues/${id}`,"DELETE")
        await setup()
    }
    return button
}
...
function createUpdateButton(id,venue,hours){
    ...
    button.onclick = async () => {
        ...
        await sendApiRequest(`https://chappen.herokuapp.com/api/venues/${id}`,"PUT",{venue: venue, hours:hours})
        await setup()
    }
    return button
}
